...
module.exports = {
  content: [
    ...
    "./node_modules/@nextui-org/theme/dist/components/(breadcrumbs|button|card|divider|drawer|dropdown|form|image|input|link|navbar|tabs|ripple|spinner|modal|menu|popover).js"
  ],
  theme: {
    extend: {
      colors: {
